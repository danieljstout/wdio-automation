...
const remote = async function (params = {}, remoteModifier) {
  ...
  const commandWrapper = params.runner ? _utils.wrapCommand : (_, origFn) => origFn;
...
const multiremote = async function (params = {}) {
  ...
  const driver = _webdriver.default.attachToSession(sessionParams, multibrowser.modifier.bind(multibrowser), prototype, _utils.wrapCommand);
